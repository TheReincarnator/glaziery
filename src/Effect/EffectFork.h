...
#ifndef __GLAZIERY_EFFECTFORK_H
#define __GLAZIERY_EFFECTFORK_H
...
namespace glaziery
{
	 ...
	 * TODO
	 */
	class EffectFork : public Effect
	{
		private:
		...
		public:
				...
				DECLARE_DYNAMIC(EffectFork);
			#endif

		public:

			/**
			 * Creates a new effect fork. After creation, add the effect to the Desktop.
			 * @see Desktop::addEffect()
			 */
			EffectFork();
