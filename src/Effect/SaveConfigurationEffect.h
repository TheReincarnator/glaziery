...
#ifndef __GLAZIERY_SAVECONFIGURATIONEFFECT_H
#define __GLAZIERY_SAVECONFIGURATIONEFFECT_H
...
namespace glaziery
{
	 ...
	 * TODO
	 */
	class SaveConfigurationEffect : public Effect
	{
		protected:
		...
		public:
				...
				DECLARE_DYNAMIC(SaveConfigurationEffect);
			#endif
	};
}
