...
#ifndef __GLAZIERY_HOTKEYEVENT_H
#define __GLAZIERY_HOTKEYEVENT_H


namespace glaziery
{
	/**
	 * The event that a hot key has been entered.
	 * Hot keys represent special characters e.g. to easily access fields
	 * (e.g. indicated by underlined characters).
	 ...
	 */
	class HotKeyEvent : public KeyEvent
	{
		friend Desktop;
		...
		public:
				...
				DECLARE_DYNAMIC(HotKeyEvent);
			#endif

		public:

			/**
			 * Creates a new hot key event.
			 *
			 ...
			 * or 0, if this character is not valid.
			 */
			HotKeyEvent(bool option1, bool option2, int scanCode, bool held, bool pressed,
